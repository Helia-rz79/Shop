  ...
  return (
    <ul>
      <li className=' flex flex-wrap justify-between'>
        <Link className='-mt-10' href='./'><img className='w-[40px] h-[40px]' src="/icon/back.svg" alt="" /></Link>
        ...
        <div className='w-full md:w-1/4 flex flex-wrap justify-center mb-2 shadow bg-gray-50 p-2 mt-3 md:mt-0 '>
          <div className='mt-3 p-1'>
            <figure className='flex gap-1 mb-1'>
              <img className='w-[20px] h-[20px]' src="/icon/warranty.svg" alt="" />
              <figcaption className='text-gray-500'>ضمانت اصالت و سلامت کالا</figcaption>
            </figure>
            <figure className='flex gap-1 mb-1'>
              <img className='w-[20px] h-[20px]' src="/icon/box.svg" alt="" />
              <figcaption className='text-gray-500'>بازگشت کالا تا ۷ روز طبق شرایط مرجوعی</figcaption>
            </figure>
            <figure className='flex gap-1'>
              <img className='w-[20px] h-[20px]' src="/icon/truck.svg" alt="" />
              <figcaption className='text-gray-500'>ارسال رایگان با خرید بیش از 2 میلیون تومان</figcaption>
            </figure>
          </div>
          <div>
            <s className='flex text-lg justify-center text-gray-500'>{data.price}</s>
            <span className='bg-sorkhabi text-white rounded-lg flex justify-center items-center w-[50px] h-[30px] text-xl text-left -translate-x-28 '>{data.discount}</span>
            <h6 className='flex text-xl justify-center mt-2'>{data.newprice} تومان</h6>
